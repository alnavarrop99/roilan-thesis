...
\label{tab:res_akf}
\small
\begin{tabular}{|p{3.8cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}|}
\hline
\textbf{Métrica} & \textbf{Exel} & \textbf{Exel+AKF} & \textbf{Mejora} \\
\hline
Precisión media [$\mu$s] & 100.33 & 66.24 & $-$33.6\% \\
\hline
Desv.\ estándar [$\mu$s] & 5.89 & 29.47 & --- \\
\hline
Reducción error vs.\ asim.\ s/c & 33.2\% & 55.9\% & +22.7~pp \\
\hline
...
\hline
Simétrico (estándar) & 49.57 & 10.05 & --- & 1.00$\times$ \\
\hline
Asimétrico s/c & 150.11 & 12.04 & 0\% (ref.) & 1.00$\times$ \\
\hline
