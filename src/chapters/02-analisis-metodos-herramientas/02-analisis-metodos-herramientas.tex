...
\small
\begin{tabular}{|p{2.8cm}|p{2.0cm}|p{1.8cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.2cm}|}
\hline
\textbf{Método} & \textbf{Categoría} & \textbf{Precisión} & \textbf{Complej.} & \textbf{Compat. gPTP} & \textbf{Asim. desc.} & \textbf{Madurez} \\
\hline
Exel (2014)~\cite{exel2014} & Corr.\ determinista & 101.5~$\mu$s (sim.) & Baja & Alta & No & Alta \\
\hline
Li et al.\ (2024)~\cite{li2024} & KF 2.º orden & $\pm 3$~$\mu$s & Media & Alta & Sí & Alta \\
\hline
Hollósi \& Ficzere (2024)~\cite{hollosi2024} & AKF & 40--60\% mejora & Media-Alta & Alta & Sí & Alta \\
\hline
Liu \& Wang (2024)~\cite{liu2024} & KF robusto & $<5$~$\mu$s RMSE & Media-Alta & Alta & Sí & Alta \\
\hline
Wang et al.\ (2021)~\cite{wang2021} & EKF sin timestamp & $<1$~$\mu$s & Media & Media & Sí & Media \\
\hline
Karthik \& Blum (2020)~\cite{karthik2020} & Est.\ robusta & Cotas óptimas & Alta & Alta & Sí & Alta \\
\hline
Nguyen et al.\ (2020)~\cite{nguyen2020} & Fuzzy-PI & $<100$~ns & Media & Media & Parcial & Media \\
\hline
Zhang et al.\ (2024)~\cite{zhang2024} & Fuzzy-PI + vent. & 52\% reducción & Media-Alta & Media & Parcial & Baja \\
\hline
Wang et al.\ (2026)~\cite{wang2026} & Compet.\ Learning & Robusto & Alta & Media-Alta & Sí & Baja \\
\hline
Puttnies et al.\ (2018)~\cite{puttnies2018} & Prog.\ Lineal & Factor $10^4$ & Media-Alta & Media & No & Media \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Parámetros del AKF y métodos de determinación.}
\label{tab:params}
\small
\begin{tabular}{|p{2.5cm}|p{5.5cm}|p{4.5cm}|}
\hline
\textbf{Parámetro} & \textbf{Descripción} & \textbf{Método de determinación} \\
\hline
...
\hline
$N$ & Tamaño de ventana para $\hat{R}_k$ & Optimización empírica (valores típicos: 10--50) \\
\hline
...
\subsection{Ventajas y desventajas de la programación en MATLAB/Octave}
\label{sec:2.4.3}
